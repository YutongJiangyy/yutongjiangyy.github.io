    ...
    <div className="min-w-0">
      <p className="text-sm leading-6 text-neutral-600">
        ...
        <button
          ...
          className={`ml-1.5 inline-flex h-5 w-5 translate-y-[4px] items-center justify-center rounded-full border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 ${
            isOpen
